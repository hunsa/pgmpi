...
class PGMPIMachineConfiguratorClusterDirect(PGMPIMachineConfigurator):

    mpirun_path = "/opt/mvapich2-2.1-gcc4.9.2/bin/mpirun"
    ...
    def get_mpi_args(self, expconfig_data):
        ...
        return "-np %s -ppn %s %s" % (nprocs, nnp, self.mpi_common_args)   
